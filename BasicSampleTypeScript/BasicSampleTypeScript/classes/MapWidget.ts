...
/// <reference path="../modules/ESRI-TypeScript/esri.amd.d.ts" /> // F.LERAY : import esri.amd.d.ts here to use the lib to create a map
/// <reference path="../modules/JQuery-TypeScript/jquery.d.ts" /> // F.LERAY : import jquery here to set the visibility to hidden when
